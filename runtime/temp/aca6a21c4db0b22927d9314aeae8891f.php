...
<div class="goods-spec-single">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-goods_score" data-rule="required" class="form-control form-control" name="spec[goods_score]" type="number" value="0">
        </div>
    </div>
    <input name="row[goods_type]" type="hidden" value="score">
    <!--<div class="form-group">-->
