...
<div class="goods-spec-single">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">商品折扣:</label>
        <div class="col-xs-12 col-sm-8">
            配额:<input  class="form-control form-control" name="discount[quota][]" type="number" value="">
            折扣:<input  class="form-control form-control" name="discount[discount][]" type="number" value="">
        </div>
    </div>
    <div class="form-group">
