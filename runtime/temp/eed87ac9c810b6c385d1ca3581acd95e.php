<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"/www/wwwroot/beike/public/../application/admin/view/user/user/edit.html";i:1560586678;s:61:"/www/wwwroot/beike/application/admin/view/layout/default.html";i:1557482264;s:58:"/www/wwwroot/beike/application/admin/view/common/meta.html";i:1557482264;s:60:"/www/wwwroot/beike/application/admin/view/common/script.html";i:1557482264;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-score" class="control-label col-xs-12 col-sm-2"><?php echo __('配额'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-quota" data-rule="required" class="form-control" name="row[quota]" type="number" value="<?php echo $row['quota']; ?>">
        </div>
    </div>
    <div class="form-group">
