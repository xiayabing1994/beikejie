define(['jquery', 'bootstrap', 'backend', 'table', 'form','template','litestoregoods'], function ($, undefined, Backend, Table, Form,Template,litestoregoods) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'litestoregoodswhole/index',
                    add_url: 'litestoregoodswhole/add',
                    edit_url: 'litestoregoodswhole/edit',
                    del_url: 'litestoregoodswhole/del',
                    multi_url: 'litestoregoodswhole/multi',
