define(['jquery', 'bootstrap', 'backend', 'table', 'form','template','litestoregoods'], function ($, undefined, Backend, Table, Form,Template,litestoregoods) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'litestoregoodsact/index',
                    add_url: 'litestoregoodsact/add',
                    edit_url: 'litestoregoodsact/edit',
                    del_url: 'litestoregoodsact/del',
                    multi_url: 'litestoregoodsact/multi',
