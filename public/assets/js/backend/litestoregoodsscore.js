define(['jquery', 'bootstrap', 'backend', 'table', 'form','template','litestoregoods'], function ($, undefined, Backend, Table, Form,Template,litestoregoods) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'litestoregoodsscore/index',
                    add_url: 'litestoregoodsscore/add',
                    edit_url: 'litestoregoodsscore/edit',
                    del_url: 'litestoregoodsscore/del',
                    multi_url: 'litestoregoodsscore/multi',
